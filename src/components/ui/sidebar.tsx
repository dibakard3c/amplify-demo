...
import { Separator } from '@estia/components/ui/separator';
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
import { Skeleton } from '@estia/components/ui/skeleton';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@estia/components/ui/tooltip';
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'mb-2 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0',
        'font-bold',
        className
      )}
      {...props}
